...
public class EBPExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(EBPDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new EBPStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static EBPDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static EBPDateTimeConverter dateTimeConverter = new EBPStandardDateTimeConverter();

    public EBPExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public EBPExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new EBPMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=EBPHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,EBPExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=EBPHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
