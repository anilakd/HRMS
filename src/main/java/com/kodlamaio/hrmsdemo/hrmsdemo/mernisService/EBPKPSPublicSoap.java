...
public class EBPKPSPublicSoap
{
    ...
    public EBPKPSPublicSoap(){}

    public EBPKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public EBPKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        EBPExtendedSoapSerializationEnvelope envelope= new EBPExtendedSoapSerializationEnvelope(EBPExtendedSoapSerializationEnvelope.VER11);
